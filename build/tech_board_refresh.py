#!/usr/bin/env python3
"""
One-shot refresh for the hosted Tech Leaderboard: computes MTD/YTD tech KPIs
from the live ServiceTitan API and writes site/tech-board/data.json.

Closed months are cached in data/tech-board-history.json (persisted between
...
import tech_board_live as engine

OUT_PATH = os.path.join(ROOT, "site", "tech-board", "data.json")
TIME_BUDGET_SECS = int(os.environ.get("TECH_BOARD_BUDGET", "420"))
