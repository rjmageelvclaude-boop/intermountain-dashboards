#!/usr/bin/env python3
"""
One-shot refresh for the hosted Silo Leaderboard: computes MTD/YTD silo tech
KPIs (TGL sales, flip rate, memberships) from the live ServiceTitan API and
writes site/silo-board/data.json.

Closed months are cached in data/silo-board-history.json (persisted between
...
import silo_board_live as engine

OUT_PATH = os.path.join(ROOT, "site", "silo-board", "data.json")
TIME_BUDGET_SECS = int(os.environ.get("SILO_BOARD_BUDGET", "420"))
