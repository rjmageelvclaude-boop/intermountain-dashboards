...
def compute_day(company, day, jt_names=None):
    ...
    m["sameDayDef"] = 4  # history recompute marker - v4: ROPP excludes
    # Management Removed ROPP (2026-07-15)
...
def compute_history(progress=None):
    ...
    Entries missing sameDayDef=4 predate the current metric definitions (v2:
    ...
    Removed ROPP - all 2026-07-15) and are recomputed once so the sparklines
