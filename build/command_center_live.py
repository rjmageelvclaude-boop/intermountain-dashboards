...
def compute_day(company, day, jt_names=None):
    ...
    m["sameDayDef"] = 5  # history recompute marker - v5: TGL set requires
    # the generating job to be Completed (2026-07-15)
...
def compute_history(progress=None):
    ...
    Entries missing sameDayDef=5 predate the current metric definitions (v2:
    ...
    to be Completed, same day) and are recomputed once so the sparklines
