#!/usr/bin/env python3
"""
One-shot refresh for the hosted Plumber Leaderboard: computes MTD/YTD plumber
KPIs from the live ServiceTitan API and writes site/plumb-board/data.json.

Closed months are cached in data/plumb-board-history.json (persisted between
...
import plumb_board_live as engine

OUT_PATH = os.path.join(ROOT, "site", "plumb-board", "data.json")
TIME_BUDGET_SECS = int(os.environ.get("PLUMB_BOARD_BUDGET", "420"))
